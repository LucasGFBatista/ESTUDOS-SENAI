...
<main class="px-5">
    ...
    <section class="sideBySide">
        ...
        <section class="container">
            <?php include "../charts/chartDollar.php" ?>
        </section>
        ...
        <!--    START LIST -->
        <section class="container">
            <?php include "../config/lists/listDollar.php" ?>
        </section>
        <!--    END LIST -->
    </section>
    <!--    END SIDE-BY-SIDE  -->
        ...
        <form action="../config/updateAction/updateActionCar.php" method="POST">
            ...
            <div class="sideBySide">
                ...
                <div class="form-right">
                    <div class="mb-3">
                        <label for="dollar">Valor do dolar</label>
                        <input type="text" name="dollar" id="dollar" value="<?= $list['dollar']; ?>">
                    </div>
