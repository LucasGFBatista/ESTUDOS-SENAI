...
<main class="px-5">
    ...
    <section class="container py-5 form-add">
        <form action="../config/updateAction/updateActionCesta.php" method="POST">
            ...
            <div class="sideBySide">
                ...
                <div class="form-right">
                    <div class="mb-3">
                        <label for="cesta">Preço carro</label>
                        <input type="text" name="cesta" id="cesta" value="<?= $list['cesta']; ?>">
                    </div>
