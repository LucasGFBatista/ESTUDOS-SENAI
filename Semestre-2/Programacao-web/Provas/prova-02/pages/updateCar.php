...
<main class="px-5">
    ...
    <section class="sideBySide">
        ...
        <section class="container">
            <?php include "../charts/chartCar.php" ?>
        </section>
        ...
        <!--    START LIST -->
        <section class="container">
            <?php include "../config/lists/listCar.php" ?>
        </section>
        <!--    END LIST -->
    </section>
    <!--    END SIDE-BY-SIDE  -->
    ...
    <section class="container py-5 form-add">
        <form action="../config/updateAction/updateActionCar.php" method="POST">
...
<div class="form-left">
            ...
            <div class="form-right">
                <div class="mb-3">
                    <label for="car_price">Preço carro</label>
                    <input type="text" name="car_price" id="car_price" value="<?= $list['car_price']; ?>">
                </div>
